...
.Lfunc_end_call_graph2:
	...
	.text
	.protected	_Z7kernel1PKfS0_PfPi    ; -- Begin function _Z7kernel1PKfS0_PfPi
	.globl	_Z7kernel1PKfS0_PfPi
	.p2align	8
	.type	_Z7kernel1PKfS0_PfPi,@function
_Z7kernel1PKfS0_PfPi:                   ; @_Z7kernel1PKfS0_PfPi
; context save logic
	; save workitem ID x
	v_mov_b32_e32 v5, v0
	; save queue_ptr SGPR
...
GLOBAL_SYNC_SPIN_LOOP:
        ...
        s_atomic_add s20, s[18:19] glc
        s_waitcnt lgkmcnt(0)
	; check if we reached the # of workgroups in the host kernel
	; maximum workable # of workgroups = # of CU * 2
        s_cmpk_lt_i32 s20, 32
        s_cbranch_scc1 GLOBAL_SYNC_SPIN_LOOP
...
GLOBAL_SYNC_LOOP_END:
	...
	; wait on workitem 0 to reach the barrier
	s_barrier
...
; begin of guest kernel
	...
	.p2align	6
	.amdhsa_kernel _Z7kernel1PKfS0_PfPi
	...
	.text
.Lfunc_end0:
	.size	_Z7kernel1PKfS0_PfPi, .Lfunc_end0-_Z7kernel1PKfS0_PfPi
                                        ; -- End function
...
amdhsa.kernels:
  - .agpr_count:     0
    ...
    .name:           _Z7kernel1PKfS0_PfPi
    .private_segment_fixed_size: 0
    .sgpr_count:     12
    .sgpr_spill_count: 0
    .symbol:         _Z7kernel1PKfS0_PfPi.kd
    .vgpr_count:     5
    .vgpr_spill_count: 0
    .wavefront_size: 64
  - .agpr_count:     0
